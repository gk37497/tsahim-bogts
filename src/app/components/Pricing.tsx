...
export default function Pricing({ data }: PriceProps) {
  return (
    <section className="py-20 bg-white dark:text-gray-100 m:py-12 lg:py-24">
      <div className="container px-4 mx-auto ">
        <div className="max-w-2xl mx-auto mb-16 text-center">
          <span className="font-bold tracking-wider uppercase dark:text-[#0245A3]">
            Pricing
          </span>
              ...
              >
                ...
                <button
                  ...
                  className={`inline-block px-5 py-3 font-semibold tracking-wider text-center rounded   ${
                    plan.isRecommended
                      ? "dark:bg-gray-900 dark:text-[#0245A3]"
                      : "dark:bg-[#0245A3] dark:text-gray-900"
                  }`}
                >
                  Get Started
                </button>
