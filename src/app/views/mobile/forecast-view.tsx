...
import CityNames from "@/app/components/city-names";
...
export default function MobileForecastView({ forecasts }: Forecasts) {
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 rounded-xl">
                {data?.weather?.map((weather, i) => {
                  return (
                    <div
                      key={i}
                      className="my-1 rounded-sm p-3 bg-gradient-to-t from-blue-200 to-transparent text-center flex flex-col space-y-8 shadow-md relative"
                    >
